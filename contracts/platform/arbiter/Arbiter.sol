...
contract Arbiter is Destructible, ArbiterInterface, Upgradable {
    ...
    {   
        ...
        require(blocks > 0, "Arbiter Error: Must be at least one block");

        // Can't reinitiate a currently active contract
        require(getDots(providerAddress, msg.sender, endpoint) == 0, "Error: Cannot reinitiate a currently active contract");
    ...
    {   
        ...
        require(dots > 0,"Error: No dots found for subscription");
